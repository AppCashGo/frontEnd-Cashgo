...
const billingCopy = {
  es: {
    ...
    totalBilledHint: "Total neto después de notas crédito.",
    totalPaid: "Cobrado",
    ...
    paidLabel: "Cobrado",
    balanceLabel: "Saldo",
    originalTotalLabel: "Total original",
    creditTotalLabel: "Notas crédito",
    netTotalLabel: "Total neto",
    creditNotesTitle: "Notas crédito asociadas",
    creditNotesDescription:
      "Estas devoluciones ya ajustaron inventario, cartera y caja. Puedes descargar cada soporte.",
    downloadCreditNote: "Descargar nota crédito",
    creditAppliedToBalance: "Aplicado a cartera",
    creditRefunded: "Reembolsado",
  ...
  en: {
    ...
    totalBilled: "Billed",
    totalBilledHint: "Net total after credit notes.",
    totalPaid: "Collected",
    ...
    creditTotalLabel: "Credit notes",
    netTotalLabel: "Net total",
    creditNotesTitle: "Linked credit notes",
    creditNotesDescription:
      "These returns have already adjusted inventory, receivables and cash. You can download each supporting document.",
    downloadCreditNote: "Download credit note",
    creditAppliedToBalance: "Applied to receivables",
